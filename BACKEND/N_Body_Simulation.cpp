...
/*
*
*	FUNCTION NAME:	NBODYFUNC_MSC
*
*	SUMMARY: The first NBODY simulation function for use with the MOON-SPACECRAFT system. This function uses leap-frog integration (AKA Kick-Drift-Kick).
*
*/
std::vector<std::vector<double>> NBODYSIM::NBODYFUNC_MSC(double totTime, double dt, std::string date_0, Eigen::RowVector3d v_vec, Eigen::RowVector3d r_vec)
{
	// Define Vector for return
	std::vector<std::vector<double>> PosVector;
	...
	Eigen::RowVector3d a_vec = get_Accel_MSC(epochTime, v_vec, r_vec);
	...
	while (epochTime < t_end) {
		...
		// Update acceleration
		a_vec = get_Accel_MSC(epochTime, v_vec, r_vec);
...
/*
*
*	FUNCTION NAME:	get_Accel_MSC
*
*	SUMMARY: Get the accelerations of the MSC system
*
*/
