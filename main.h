...
// Load glad in for image rendering and utilities functions
#include <glad/glad.h>
#include <GLFW/glfw3.h>

// load in shader and rendering data
#include <shader.h>
#include <shapeData.h>
#include <Sphere.h>

// load in time functionality
#include <chrono>
...
// Define Constants
#define M_PI           3.14159265358979323846  /* pi */ //This is normally defined in math.h, but it will be defined here since it is the only variable needed
...
// --- 3D shaders for spherical icons
// Vertex Shader Component
